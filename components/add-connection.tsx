...
export function AddConnection() {
  ...
  return (
    <form action={formAction} className="w-full max-w-md text-base-content" onSubmit={() => toast({ description: 'Added new connection' })}>
      <Card>
        <CardHeader>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            <Input name="username" placeholder="optional" type="text" autoComplete="username" />
          </div>
          <div className="space-y-1">
        ...
        <CardFooter
          className="my-4 px-0 flex justify-between"
        >
          ...
          <Button type="submit" className="bg-primary text-primary-content" aria-disabled={pending}>
            Save and Connect
          </Button>
        </CardFooter>
      </Card>
